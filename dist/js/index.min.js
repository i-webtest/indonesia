...
"use strict";
"use strict";var itemMonth=document.querySelectorAll(".calendar__item_month"),calendarDate=document.querySelectorAll(".calendar__date"),changeDate=function(e,t){e.forEach((function(e){e.dataset.field===t?e.style.display="flex":e.style.display="none"}))};itemMonth.forEach((function(e){e.addEventListener("mouseenter",(function(t){var n=e.dataset.handler;e.style.cssText="color: #FCB500; font-size: 16px;",changeDate(calendarDate,n)})),e.addEventListener("mouseleave",(function(t){e.style.cssText=""}))}));
"use strict";
"use strict";
