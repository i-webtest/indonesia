...
"use strict";var select1=document.querySelector("#select-1"),selectToggle1=document.querySelector("#select-1 .itc-select__toggle"),selectToggle2=document.querySelector("#select-2 .itc-select1__toggle"),selectToggle3=document.querySelector("#select-3 .itc-select2__toggle"),selectToggle4=document.querySelector("#select-4 .itc-select__toggle"),selectToggle5=document.querySelector("#select-5 .itc-select5__toggle"),selectToggle6=document.querySelector("#select-6 .itc-select6__toggle"),selectInput=document.querySelectorAll(".itc-select2__input"),selectInput6=document.querySelectorAll(".itc-select6__input"),input4=document.querySelector("#select-4 input"),select2=document.querySelector("#select-2"),select3=document.querySelector("#select-3"),select4=document.querySelector("#select-4"),select5=document.querySelector("#select-5"),select6=document.querySelector("#select-6"),btn=document.querySelector(".itc-select2__toggle"),option=document.querySelectorAll(".itc-select2__option");option.forEach((function(e){e.addEventListener("change",(function(){btn.textContent=e.textContent}))}));var btn6=document.querySelector(".itc-select6__toggle"),option6=document.querySelectorAll(".itc-select6__option");option6.forEach((function(e){e.addEventListener("change",(function(){btn6.textContent=e.textContent}))})),selectToggle1.addEventListener("click",(function(){selectToggle4.value=selectToggle1.textContent,selectToggle4.textContent=selectToggle4.value})),selectToggle2.addEventListener("click",(function(){selectToggle5.value=selectToggle2.textContent,selectToggle5.textContent=selectToggle5.value})),selectToggle3.addEventListener("click",(function(){selectToggle6.textContent=selectToggle3.textContent})),selectInput.forEach((function(e){e.addEventListener("click",(function(){selectToggle3.value=e.value,selectToggle6.textContent=e.value,selectToggle6.value=selectToggle6.textContent}))})),selectInput6.forEach((function(e){e.addEventListener("change",(function(){selectToggle6.value=e.value}))}));
