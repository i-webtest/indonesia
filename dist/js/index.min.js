...
"use strict";var btn=document.querySelector(".itc-select2__toggle");console.log("btn: ",btn.textContent);var option=document.querySelectorAll(".itc-select2__option");option.forEach((function(t){t.addEventListener("change",(function(){btn.textContent=t.textContent}))}));var btn6=document.querySelector(".itc-select6__toggle");console.log("btn: ",btn.textContent);var option6=document.querySelectorAll(".itc-select6__option");option6.forEach((function(t){t.addEventListener("change",(function(){btn6.textContent=t.textContent}))}));
"use strict";
"use strict";
