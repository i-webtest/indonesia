...
"use strict";var description=document.querySelectorAll(".travel__item-text"),btns=document.querySelectorAll(".travel__item-title");btns.forEach((function(t,e){t.addEventListener("click",(function(){btns.forEach((function(t){t.classList.remove("active")})),t.classList.add("active"),description.forEach((function(t){t.classList.add("hidden")})),description[e].classList.remove("hidden")}))}));
"use strict";var selectToggle1=document.querySelector("#select-1 .itc-select__toggle"),selectToggle2=document.querySelector("#select-2 .itc-select1__toggle"),selectToggle3=document.querySelector("#select-3 .itc-select2__toggle"),selectToggle4=document.querySelector("#select-4 .itc-select__toggle"),selectToggle5=document.querySelector("#select-5 .itc-select5__toggle"),selectToggle6=document.querySelector("#select-6 .itc-select6__toggle"),selectInput=document.querySelectorAll(".itc-select2__input"),selectInput6=document.querySelectorAll(".itc-select6__input"),input4=document.querySelector("#select-4 input"),select1=document.querySelector("#select-1"),select2=document.querySelector("#select-2"),select3=document.querySelector("#select-3"),select4=document.querySelector("#select-4"),select5=document.querySelector("#select-5"),select6=document.querySelector("#select-6"),labelDate=document.querySelector(".tour__form-label_date"),labelPeople=document.querySelector(".tour__form-label_people"),labelOption=document.querySelector(".tour__form-label_option"),btn=document.querySelector(".itc-select2__toggle"),option=document.querySelectorAll(".itc-select2__option");option.forEach((function(e){e.addEventListener("change",(function(){btn.textContent=e.textContent}))}));var btn6=document.querySelector(".itc-select6__toggle"),option6=document.querySelectorAll(".itc-select6__option");option6.forEach((function(e){e.addEventListener("change",(function(){btn6.textContent=e.textContent}))})),selectToggle1.addEventListener("click",(function(){selectToggle4.value=selectToggle1.textContent,selectToggle4.textContent=selectToggle4.value})),selectToggle2.addEventListener("click",(function(){selectToggle5.value=selectToggle2.textContent,selectToggle5.textContent=selectToggle5.value})),selectToggle3.addEventListener("click",(function(){selectToggle6.textContent=selectToggle3.textContent})),selectInput.forEach((function(e){e.addEventListener("click",(function(){selectToggle3.value=e.value,selectToggle6.textContent=e.value,selectToggle6.value=selectToggle6.textContent}))})),selectInput6.forEach((function(e){e.addEventListener("change",(function(){selectToggle6.value=e.value}))}));
"use strict";var footerForm=function(t){var e=t.formId,o=(t.someElem,document.getElementById(e)),n=document.querySelector(".footer__form-input"),r=document.querySelector(".footer__form-input[placeholder]"),c=function(){var t,e,c=o.querySelectorAll("input"),l=new FormData(o),u={};r.textContent="Загрузка...",l.forEach((function(t,e){u[e]=t})),e=!0,c.forEach((function(t){t.style.color=null,t.style.borderBottom=null,"email"===t.name?0===t.value.length&&(r.style.color="red",n.style.borderBottom="1px solid red",e=!1):e=!0})),e?(t=u,fetch("https://jsonplaceholder.typicode.com/posts",{method:"POST",body:JSON.stringify(t),headers:{"Content-Type":"application/json"}}).then((function(t){return t.json()}))).then((function(t){r.textContent="Спасибо! Наш менеджер с вами свяжется!",c.forEach((function(t){t.value=""})),setInterval((function(){r.textContent="Бронирование тура"}),3e3)})).catch((function(t){r.textContent="Ошибка..."})):(r.textContent="Попробуйте ещё раз...",setTimeout((function(){r.textContent="Бронирование тура"}),2e3))};try{if(!o)throw new Error("Верните форму на место!");o.addEventListener("submit",(function(t){t.preventDefault(),c()}))}catch(t){}};footerForm({formId:"form1"});
"use strict";function _typeof(t){return _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},_typeof(t)}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _defineProperties(t,e){for(var o=0;o<e.length;o++){var n=e[o];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,_toPropertyKey(n.key),n)}}function _createClass(t,e,o){return e&&_defineProperties(t.prototype,e),o&&_defineProperties(t,o),Object.defineProperty(t,"prototype",{writable:!1}),t}function _defineProperty(t,e,o){return(e=_toPropertyKey(e))in t?Object.defineProperty(t,e,{value:o,enumerable:!0,configurable:!0,writable:!0}):t[e]=o,t}function _toPropertyKey(t){var e=_toPrimitive(t,"string");return"symbol"===_typeof(e)?e:String(e)}function _toPrimitive(t,e){if("object"!==_typeof(t)||null===t)return t;var o=t[Symbol.toPrimitive];if(void 0!==o){var n=o.call(t,e||"default");if("object"!==_typeof(n))return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===e?String:Number)(t)}var ItcCustomSelect=function(){function t(e,o){_classCallCheck(this,t),this._el="string"==typeof e?document.querySelector(e):e,this._params=o||{},this._onClickFn=this._onClick.bind(this),this._params.options&&(this._el.innerHTML=this.constructor.template(this._params),this._el.classList.add(this.constructor.EL)),this._elToggle=this._el.querySelector(this.constructor.DATA_TOGGLE),this._el.addEventListener("click",this._onClickFn)}return _createClass(t,[{key:"_onClick",value:function(t){var e=t.target,o=e.closest(this.constructor.DATA).dataset.select;"toggle"===o?this.toggle():"option"===o&&this._changeValue(e)}},{key:"_updateOption",value:function(t){var e=t.closest(".".concat(this.constructor.EL_OPTION)),o=this._el.querySelector(".".concat(this.constructor.EL_OPTION_SELECTED));return o&&o.classList.remove(this.constructor.EL_OPTION_SELECTED),e.classList.add(this.constructor.EL_OPTION_SELECTED),this._elToggle.textContent=e.textContent,this._elToggle.value=e.dataset.value,this._elToggle.dataset.index=e.dataset.index,this._el.dispatchEvent(new CustomEvent("itc.select.change")),this._params.onSelected&&this._params.onSelected(this,e),e.dataset.value}},{key:"_reset",value:function(){var t=this._el.querySelector(".".concat(this.constructor.EL_OPTION_SELECTED));return t&&t.classList.remove(this.constructor.EL_OPTION_SELECTED),this._elToggle.textContent="Выберите из списка",this._elToggle.value="",this._elToggle.dataset.index="-1",this._el.dispatchEvent(new CustomEvent("itc.select.change")),this._params.onSelected&&this._params.onSelected(this,null),""}},{key:"_changeValue",value:function(t){t.classList.contains(this.constructor.EL_OPTION_SELECTED)||(this._updateOption(t),this.hide())}},{key:"show",value:function(){var t=this;document.querySelectorAll(this.constructor.EL_SHOW).forEach((function(e){e.classList.remove(t.constructor.EL_SHOW)})),this._el.classList.add("".concat(this.constructor.EL_SHOW))}},{key:"hide",value:function(){this._el.classList.remove(this.constructor.EL_SHOW)}},{key:"toggle",value:function(){this._el.classList.contains(this.constructor.EL_SHOW)?this.hide():this.show()}},{key:"dispose",value:function(){this._el.removeEventListener("click",this._onClickFn)}},{key:"value",get:function(){return this._elToggle.value},set:function(t){var e=this,o=!1;this._el.querySelectorAll(".select__option").forEach((function(n){n.dataset.value===t&&(o=!0,e._updateOption(n))})),o||this._reset()}},{key:"selectedIndex",get:function(){return this._elToggle.dataset.index},set:function(t){var e=this._el.querySelector('.select__option[data-index="'.concat(t,'"]'));e&&this._updateOption(e),this._reset()}}],[{key:"template",value:function(t){var e=this,o=t.name,n=t.options,c=t.targetValue,i=[],s=-1,r="",l="Выберите из списка";return n.forEach((function(t,o){var n="";t[0]===c&&(n=" ".concat(e.EL_OPTION_SELECTED),s=o,r=t[0],l=t[1]),i.push('<li class="itc-select__option'.concat(n,'" data-select="option"\n        data-value="').concat(t[0],'" data-index="').concat(o,'">').concat(t[1],"</li>"))})),'<button type="button" class="itc-select__toggle" name="'.concat(o,'"\n      value="').concat(r,'" data-select="toggle" data-index="').concat(s,'">\n      ').concat(l,'</button><div class="itc-select__dropdown">\n      <ul class="itc-select__options">').concat(i.join(""),"</ul></div>")}},{key:"hideOpenSelect",value:function(){var t=this;document.addEventListener("click",(function(e){e.target.closest(".".concat(t.EL))||document.querySelectorAll(".".concat(t.EL_SHOW)).forEach((function(e){e.classList.remove(t.EL_SHOW)}))}))}},{key:"create",value:function(t,e){return this._el="string"==typeof t?document.querySelector(t):t,this._el?new this(t,e):null}}]),t}();_defineProperty(ItcCustomSelect,"EL","itc-select"),_defineProperty(ItcCustomSelect,"EL_SHOW","itc-select_show"),_defineProperty(ItcCustomSelect,"EL_OPTION","itc-select__option"),_defineProperty(ItcCustomSelect,"EL_OPTION_SELECTED","itc-select__option_selected"),_defineProperty(ItcCustomSelect,"DATA","[data-select]"),_defineProperty(ItcCustomSelect,"DATA_TOGGLE",'[data-select="toggle"]'),ItcCustomSelect.hideOpenSelect();var select1=new ItcCustomSelect("#select-1");
"use strict";function _typeof(t){return _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},_typeof(t)}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _defineProperties(t,e){for(var o=0;o<e.length;o++){var n=e[o];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,_toPropertyKey(n.key),n)}}function _createClass(t,e,o){return e&&_defineProperties(t.prototype,e),o&&_defineProperties(t,o),Object.defineProperty(t,"prototype",{writable:!1}),t}function _defineProperty(t,e,o){return(e=_toPropertyKey(e))in t?Object.defineProperty(t,e,{value:o,enumerable:!0,configurable:!0,writable:!0}):t[e]=o,t}function _toPropertyKey(t){var e=_toPrimitive(t,"string");return"symbol"===_typeof(e)?e:String(e)}function _toPrimitive(t,e){if("object"!==_typeof(t)||null===t)return t;var o=t[Symbol.toPrimitive];if(void 0!==o){var n=o.call(t,e||"default");if("object"!==_typeof(n))return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===e?String:Number)(t)}var ItcCustomSelect=function(){function t(e,o){_classCallCheck(this,t),this._el="string"==typeof e?document.querySelector(e):e,this._params=o||{},this._onClickFn=this._onClick.bind(this),this._params.options&&(this._el.innerHTML=this.constructor.template(this._params),this._el.classList.add(this.constructor.EL)),this._elToggle=this._el.querySelector(this.constructor.DATA_TOGGLE),this._el.addEventListener("click",this._onClickFn)}return _createClass(t,[{key:"_onClick",value:function(t){var e=t.target,o=e.closest(this.constructor.DATA).dataset.select;"toggle"===o?this.toggle():"option"===o&&this._changeValue(e)}},{key:"_updateOption",value:function(t){var e=t.closest(".".concat(this.constructor.EL_OPTION)),o=this._el.querySelector(".".concat(this.constructor.EL_OPTION_SELECTED));return o&&o.classList.remove(this.constructor.EL_OPTION_SELECTED),e.classList.add(this.constructor.EL_OPTION_SELECTED),this._elToggle.textContent=e.textContent,this._elToggle.value=e.dataset.value,this._elToggle.dataset.index=e.dataset.index,this._el.dispatchEvent(new CustomEvent("itc.select.change")),this._params.onSelected&&this._params.onSelected(this,e),e.dataset.value}},{key:"_reset",value:function(){var t=this._el.querySelector(".".concat(this.constructor.EL_OPTION_SELECTED));return t&&t.classList.remove(this.constructor.EL_OPTION_SELECTED),this._elToggle.textContent="Выберите из списка",this._elToggle.value="",this._elToggle.dataset.index="-1",this._el.dispatchEvent(new CustomEvent("itc.select.change")),this._params.onSelected&&this._params.onSelected(this,null),""}},{key:"_changeValue",value:function(t){t.classList.contains(this.constructor.EL_OPTION_SELECTED)||(this._updateOption(t),this.hide())}},{key:"show",value:function(){var t=this;document.querySelectorAll(this.constructor.EL_SHOW).forEach((function(e){e.classList.remove(t.constructor.EL_SHOW)})),this._el.classList.add("".concat(this.constructor.EL_SHOW))}},{key:"hide",value:function(){this._el.classList.remove(this.constructor.EL_SHOW)}},{key:"toggle",value:function(){this._el.classList.contains(this.constructor.EL_SHOW)?this.hide():this.show()}},{key:"dispose",value:function(){this._el.removeEventListener("click",this._onClickFn)}},{key:"value",get:function(){return this._elToggle.value},set:function(t){var e=this,o=!1;this._el.querySelectorAll(".select__option").forEach((function(n){n.dataset.value===t&&(o=!0,e._updateOption(n))})),o||this._reset()}},{key:"selectedIndex",get:function(){return this._elToggle.dataset.index},set:function(t){var e=this._el.querySelector('.select__option[data-index="'.concat(t,'"]'));e&&this._updateOption(e),this._reset()}}],[{key:"template",value:function(t){var e=this,o=t.name,n=t.options,c=t.targetValue,i=[],s=-1,r="",l="Выберите из списка";return n.forEach((function(t,o){var n="";t[0]===c&&(n=" ".concat(e.EL_OPTION_SELECTED),s=o,r=t[0],l=t[1]),i.push('<li class="itc-select1__option'.concat(n,'" data-select="option"\n        data-value="').concat(t[0],'" data-index="').concat(o,'">').concat(t[1],"</li>"))})),'<button type="button" class="itc-select__toggle" name="'.concat(o,'"\n      value="').concat(r,'" data-select="toggle" data-index="').concat(s,'">\n      ').concat(l,'</button><div class="itc-select__dropdown">\n      <ul class="itc-select__options">').concat(i.join(""),"</ul></div>")}},{key:"hideOpenSelect",value:function(){var t=this;document.addEventListener("click",(function(e){e.target.closest(".".concat(t.EL))||document.querySelectorAll(".".concat(t.EL_SHOW)).forEach((function(e){e.classList.remove(t.EL_SHOW)}))}))}},{key:"create",value:function(t,e){return this._el="string"==typeof t?document.querySelector(t):t,this._el?new this(t,e):null}}]),t}();_defineProperty(ItcCustomSelect,"EL","itc-select1"),_defineProperty(ItcCustomSelect,"EL_SHOW","itc-select1_show"),_defineProperty(ItcCustomSelect,"EL_OPTION","itc-select1__option"),_defineProperty(ItcCustomSelect,"EL_OPTION_SELECTED","itc-select1__option_selected"),_defineProperty(ItcCustomSelect,"DATA","[data-select]"),_defineProperty(ItcCustomSelect,"DATA_TOGGLE",'[data-select="toggle"]'),ItcCustomSelect.hideOpenSelect();var select2=new ItcCustomSelect("#select-2");
"use strict";function _typeof(t){return _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},_typeof(t)}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _defineProperties(t,e){for(var o=0;o<e.length;o++){var n=e[o];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,_toPropertyKey(n.key),n)}}function _createClass(t,e,o){return e&&_defineProperties(t.prototype,e),o&&_defineProperties(t,o),Object.defineProperty(t,"prototype",{writable:!1}),t}function _defineProperty(t,e,o){return(e=_toPropertyKey(e))in t?Object.defineProperty(t,e,{value:o,enumerable:!0,configurable:!0,writable:!0}):t[e]=o,t}function _toPropertyKey(t){var e=_toPrimitive(t,"string");return"symbol"===_typeof(e)?e:String(e)}function _toPrimitive(t,e){if("object"!==_typeof(t)||null===t)return t;var o=t[Symbol.toPrimitive];if(void 0!==o){var n=o.call(t,e||"default");if("object"!==_typeof(n))return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===e?String:Number)(t)}var ItcCustomSelect=function(){function t(e,o){_classCallCheck(this,t),this._el="string"==typeof e?document.querySelector(e):e,this._params=o||{},this._onClickFn=this._onClick.bind(this),this._params.options&&(this._el.innerHTML=this.constructor.template(this._params),this._el.classList.add(this.constructor.EL)),this._elToggle=this._el.querySelector(this.constructor.DATA_TOGGLE),this._el.addEventListener("click",this._onClickFn)}return _createClass(t,[{key:"_onClick",value:function(t){var e=t.target,o=e.closest(this.constructor.DATA).dataset.select;"toggle"===o?this.toggle():"option"===o&&this._changeValue(e)}},{key:"_updateOption",value:function(t){var e=t.closest(".".concat(this.constructor.EL_OPTION)),o=this._el.querySelector(".".concat(this.constructor.EL_OPTION_SELECTED));return o&&o.classList.remove(this.constructor.EL_OPTION_SELECTED),e.classList.add(this.constructor.EL_OPTION_SELECTED),this._elToggle.textContent=e.textContent,this._elToggle.value=e.dataset.value,this._elToggle.dataset.index=e.dataset.index,this._el.dispatchEvent(new CustomEvent("itc.select.change")),this._params.onSelected&&this._params.onSelected(this,e),e.dataset.value}},{key:"_reset",value:function(){var t=this._el.querySelector(".".concat(this.constructor.EL_OPTION_SELECTED));return t&&t.classList.remove(this.constructor.EL_OPTION_SELECTED),this._elToggle.textContent="Выберите из списка",this._elToggle.value="",this._elToggle.dataset.index="-1",this._el.dispatchEvent(new CustomEvent("itc.select.change")),this._params.onSelected&&this._params.onSelected(this,null),""}},{key:"_changeValue",value:function(t){t.classList.contains(this.constructor.EL_OPTION_SELECTED)||(this._updateOption(t),this.hide())}},{key:"show",value:function(){var t=this;document.querySelectorAll(this.constructor.EL_SHOW).forEach((function(e){e.classList.remove(t.constructor.EL_SHOW)})),this._el.classList.add("".concat(this.constructor.EL_SHOW))}},{key:"hide",value:function(){this._el.classList.remove(this.constructor.EL_SHOW)}},{key:"toggle",value:function(){this._el.classList.contains(this.constructor.EL_SHOW)?this.hide():this.show()}},{key:"dispose",value:function(){this._el.removeEventListener("click",this._onClickFn)}},{key:"value",get:function(){return this._elToggle.value},set:function(t){var e=this,o=!1;this._el.querySelectorAll(".select__option").forEach((function(n){n.dataset.value===t&&(o=!0,e._updateOption(n))})),o||this._reset()}},{key:"selectedIndex",get:function(){return this._elToggle.dataset.index},set:function(t){var e=this._el.querySelector('.select__option[data-index="'.concat(t,'"]'));e&&this._updateOption(e),this._reset()}}],[{key:"template",value:function(t){var e=this,o=t.name,n=t.options,c=t.targetValue,i=[],s=-1,r="",l="Выберите из списка";return n.forEach((function(t,o){var n="";t[0]===c&&(n=" ".concat(e.EL_OPTION_SELECTED),s=o,r=t[0],l=t[1]),i.push('<li class="itc-select2__option'.concat(n,'" data-select="option"\n        data-value="').concat(t[0],'" data-index="').concat(o,'">').concat(t[1],"</li>"))})),'<button type="button" class="itc-select__toggle" name="'.concat(o,'"\n      value="').concat(r,'" data-select="toggle" data-index="').concat(s,'">\n      ').concat(l,'</button><div class="itc-select__dropdown">\n      <ul class="itc-select__options">').concat(i.join(""),"</ul></div>")}},{key:"hideOpenSelect",value:function(){var t=this;document.addEventListener("click",(function(e){e.target.closest(".".concat(t.EL))||document.querySelectorAll(".".concat(t.EL_SHOW)).forEach((function(e){e.classList.remove(t.EL_SHOW)}))}))}},{key:"create",value:function(t,e){return this._el="string"==typeof t?document.querySelector(t):t,this._el?new this(t,e):null}}]),t}();_defineProperty(ItcCustomSelect,"EL","itc-select2"),_defineProperty(ItcCustomSelect,"EL_SHOW","itc-select2_show"),_defineProperty(ItcCustomSelect,"EL_OPTION","itc-select2__option"),_defineProperty(ItcCustomSelect,"EL_OPTION_SELECTED","itc-select2__option_selected"),_defineProperty(ItcCustomSelect,"DATA","[data-select]"),_defineProperty(ItcCustomSelect,"DATA_TOGGLE",'[data-select="toggle"]'),ItcCustomSelect.hideOpenSelect();var select3=new ItcCustomSelect("#select-3");
"use strict";function _typeof(t){return _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},_typeof(t)}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _defineProperties(t,e){for(var o=0;o<e.length;o++){var n=e[o];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,_toPropertyKey(n.key),n)}}function _createClass(t,e,o){return e&&_defineProperties(t.prototype,e),o&&_defineProperties(t,o),Object.defineProperty(t,"prototype",{writable:!1}),t}function _defineProperty(t,e,o){return(e=_toPropertyKey(e))in t?Object.defineProperty(t,e,{value:o,enumerable:!0,configurable:!0,writable:!0}):t[e]=o,t}function _toPropertyKey(t){var e=_toPrimitive(t,"string");return"symbol"===_typeof(e)?e:String(e)}function _toPrimitive(t,e){if("object"!==_typeof(t)||null===t)return t;var o=t[Symbol.toPrimitive];if(void 0!==o){var n=o.call(t,e||"default");if("object"!==_typeof(n))return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===e?String:Number)(t)}var ItcCustomSelect=function(){function t(e,o){_classCallCheck(this,t),this._el="string"==typeof e?document.querySelector(e):e,this._params=o||{},this._onClickFn=this._onClick.bind(this),this._params.options&&(this._el.innerHTML=this.constructor.template(this._params),this._el.classList.add(this.constructor.EL)),this._elToggle=this._el.querySelector(this.constructor.DATA_TOGGLE),this._el.addEventListener("click",this._onClickFn)}return _createClass(t,[{key:"_onClick",value:function(t){var e=t.target,o=e.closest(this.constructor.DATA).dataset.select;"toggle"===o?this.toggle():"option"===o&&this._changeValue(e)}},{key:"_updateOption",value:function(t){var e=t.closest(".".concat(this.constructor.EL_OPTION)),o=this._el.querySelector(".".concat(this.constructor.EL_OPTION_SELECTED));return o&&o.classList.remove(this.constructor.EL_OPTION_SELECTED),e.classList.add(this.constructor.EL_OPTION_SELECTED),this._elToggle.textContent=e.textContent,this._elToggle.value=e.dataset.value,this._elToggle.dataset.index=e.dataset.index,this._el.dispatchEvent(new CustomEvent("itc.select.change")),this._params.onSelected&&this._params.onSelected(this,e),e.dataset.value}},{key:"_reset",value:function(){var t=this._el.querySelector(".".concat(this.constructor.EL_OPTION_SELECTED));return t&&t.classList.remove(this.constructor.EL_OPTION_SELECTED),this._elToggle.textContent="Выберите из списка",this._elToggle.value="",this._elToggle.dataset.index="-1",this._el.dispatchEvent(new CustomEvent("itc.select.change")),this._params.onSelected&&this._params.onSelected(this,null),""}},{key:"_changeValue",value:function(t){t.classList.contains(this.constructor.EL_OPTION_SELECTED)||(this._updateOption(t),this.hide())}},{key:"show",value:function(){var t=this;document.querySelectorAll(this.constructor.EL_SHOW).forEach((function(e){e.classList.remove(t.constructor.EL_SHOW)})),this._el.classList.add("".concat(this.constructor.EL_SHOW))}},{key:"hide",value:function(){this._el.classList.remove(this.constructor.EL_SHOW)}},{key:"toggle",value:function(){this._el.classList.contains(this.constructor.EL_SHOW)?this.hide():this.show()}},{key:"dispose",value:function(){this._el.removeEventListener("click",this._onClickFn)}},{key:"value",get:function(){return this._elToggle.value},set:function(t){var e=this,o=!1;this._el.querySelectorAll(".select__option").forEach((function(n){n.dataset.value===t&&(o=!0,e._updateOption(n))})),o||this._reset()}},{key:"selectedIndex",get:function(){return this._elToggle.dataset.index},set:function(t){var e=this._el.querySelector('.select__option[data-index="'.concat(t,'"]'));e&&this._updateOption(e),this._reset()}}],[{key:"template",value:function(t){var e=this,o=t.name,n=t.options,c=t.targetValue,i=[],s=-1,r="",l="Выберите из списка";return n.forEach((function(t,o){var n="";t[0]===c&&(n=" ".concat(e.EL_OPTION_SELECTED),s=o,r=t[0],l=t[1]),i.push('<li class="itc-select__option'.concat(n,'" data-select="option"\n        data-value="').concat(t[0],'" data-index="').concat(o,'">').concat(t[1],"</li>"))})),'<button type="button" class="itc-select__toggle" name="'.concat(o,'"\n      value="').concat(r,'" data-select="toggle" data-index="').concat(s,'">\n      ').concat(l,'</button><div class="itc-select__dropdown">\n      <ul class="itc-select__options">').concat(i.join(""),"</ul></div>")}},{key:"hideOpenSelect",value:function(){var t=this;document.addEventListener("click",(function(e){e.target.closest(".".concat(t.EL))||document.querySelectorAll(".".concat(t.EL_SHOW)).forEach((function(e){e.classList.remove(t.EL_SHOW)}))}))}},{key:"create",value:function(t,e){return this._el="string"==typeof t?document.querySelector(t):t,this._el?new this(t,e):null}}]),t}();_defineProperty(ItcCustomSelect,"EL","itc-select"),_defineProperty(ItcCustomSelect,"EL_SHOW","itc-select_show"),_defineProperty(ItcCustomSelect,"EL_OPTION","itc-select__option"),_defineProperty(ItcCustomSelect,"EL_OPTION_SELECTED","itc-select__option_selected"),_defineProperty(ItcCustomSelect,"DATA","[data-select]"),_defineProperty(ItcCustomSelect,"DATA_TOGGLE",'[data-select="toggle"]'),ItcCustomSelect.hideOpenSelect();var select1=new ItcCustomSelect("#select-4");
"use strict";function _typeof(t){return _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},_typeof(t)}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _defineProperties(t,e){for(var o=0;o<e.length;o++){var n=e[o];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,_toPropertyKey(n.key),n)}}function _createClass(t,e,o){return e&&_defineProperties(t.prototype,e),o&&_defineProperties(t,o),Object.defineProperty(t,"prototype",{writable:!1}),t}function _defineProperty(t,e,o){return(e=_toPropertyKey(e))in t?Object.defineProperty(t,e,{value:o,enumerable:!0,configurable:!0,writable:!0}):t[e]=o,t}function _toPropertyKey(t){var e=_toPrimitive(t,"string");return"symbol"===_typeof(e)?e:String(e)}function _toPrimitive(t,e){if("object"!==_typeof(t)||null===t)return t;var o=t[Symbol.toPrimitive];if(void 0!==o){var n=o.call(t,e||"default");if("object"!==_typeof(n))return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===e?String:Number)(t)}var ItcCustomSelect=function(){function t(e,o){_classCallCheck(this,t),this._el="string"==typeof e?document.querySelector(e):e,this._params=o||{},this._onClickFn=this._onClick.bind(this),this._params.options&&(this._el.innerHTML=this.constructor.template(this._params),this._el.classList.add(this.constructor.EL)),this._elToggle=this._el.querySelector(this.constructor.DATA_TOGGLE),this._el.addEventListener("click",this._onClickFn)}return _createClass(t,[{key:"_onClick",value:function(t){var e=t.target,o=e.closest(this.constructor.DATA).dataset.select;"toggle"===o?this.toggle():"option"===o&&this._changeValue(e)}},{key:"_updateOption",value:function(t){var e=t.closest(".".concat(this.constructor.EL_OPTION)),o=this._el.querySelector(".".concat(this.constructor.EL_OPTION_SELECTED));return o&&o.classList.remove(this.constructor.EL_OPTION_SELECTED),e.classList.add(this.constructor.EL_OPTION_SELECTED),this._elToggle.textContent=e.textContent,this._elToggle.value=e.dataset.value,this._elToggle.dataset.index=e.dataset.index,this._el.dispatchEvent(new CustomEvent("itc.select.change")),this._params.onSelected&&this._params.onSelected(this,e),e.dataset.value}},{key:"_reset",value:function(){var t=this._el.querySelector(".".concat(this.constructor.EL_OPTION_SELECTED));return t&&t.classList.remove(this.constructor.EL_OPTION_SELECTED),this._elToggle.textContent="Выберите из списка",this._elToggle.value="",this._elToggle.dataset.index="-1",this._el.dispatchEvent(new CustomEvent("itc.select.change")),this._params.onSelected&&this._params.onSelected(this,null),""}},{key:"_changeValue",value:function(t){t.classList.contains(this.constructor.EL_OPTION_SELECTED)||(this._updateOption(t),this.hide())}},{key:"show",value:function(){var t=this;document.querySelectorAll(this.constructor.EL_SHOW).forEach((function(e){e.classList.remove(t.constructor.EL_SHOW)})),this._el.classList.add("".concat(this.constructor.EL_SHOW))}},{key:"hide",value:function(){this._el.classList.remove(this.constructor.EL_SHOW)}},{key:"toggle",value:function(){this._el.classList.contains(this.constructor.EL_SHOW)?this.hide():this.show()}},{key:"dispose",value:function(){this._el.removeEventListener("click",this._onClickFn)}},{key:"value",get:function(){return this._elToggle.value},set:function(t){var e=this,o=!1;this._el.querySelectorAll(".select__option").forEach((function(n){n.dataset.value===t&&(o=!0,e._updateOption(n))})),o||this._reset()}},{key:"selectedIndex",get:function(){return this._elToggle.dataset.index},set:function(t){var e=this._el.querySelector('.select__option[data-index="'.concat(t,'"]'));e&&this._updateOption(e),this._reset()}}],[{key:"template",value:function(t){var e=this,o=t.name,n=t.options,c=t.targetValue,i=[],s=-1,r="",l="Выберите из списка";return n.forEach((function(t,o){var n="";t[0]===c&&(n=" ".concat(e.EL_OPTION_SELECTED),s=o,r=t[0],l=t[1]),i.push('<li class="itc-select5__option'.concat(n,'" data-select="option"\n        data-value="').concat(t[0],'" data-index="').concat(o,'">').concat(t[1],"</li>"))})),'<button type="button" class="itc-select5__toggle" name="'.concat(o,'"\n      value="').concat(r,'" data-select="toggle" data-index="').concat(s,'">\n      ').concat(l,'</button><div class="itc-select5__dropdown">\n      <ul class="itc-select5__options">').concat(i.join(""),"</ul></div>")}},{key:"hideOpenSelect",value:function(){var t=this;document.addEventListener("click",(function(e){e.target.closest(".".concat(t.EL))||document.querySelectorAll(".".concat(t.EL_SHOW)).forEach((function(e){e.classList.remove(t.EL_SHOW)}))}))}},{key:"create",value:function(t,e){return this._el="string"==typeof t?document.querySelector(t):t,this._el?new this(t,e):null}}]),t}();_defineProperty(ItcCustomSelect,"EL","itc-select5"),_defineProperty(ItcCustomSelect,"EL_SHOW","itc-select5_show"),_defineProperty(ItcCustomSelect,"EL_OPTION","itc-select5__option"),_defineProperty(ItcCustomSelect,"EL_OPTION_SELECTED","itc-select5__option_selected"),_defineProperty(ItcCustomSelect,"DATA","[data-select]"),_defineProperty(ItcCustomSelect,"DATA_TOGGLE",'[data-select="toggle"]'),ItcCustomSelect.hideOpenSelect();var select5=new ItcCustomSelect("#select-5");
"use strict";function _typeof(t){return _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},_typeof(t)}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _defineProperties(t,e){for(var o=0;o<e.length;o++){var n=e[o];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,_toPropertyKey(n.key),n)}}function _createClass(t,e,o){return e&&_defineProperties(t.prototype,e),o&&_defineProperties(t,o),Object.defineProperty(t,"prototype",{writable:!1}),t}function _defineProperty(t,e,o){return(e=_toPropertyKey(e))in t?Object.defineProperty(t,e,{value:o,enumerable:!0,configurable:!0,writable:!0}):t[e]=o,t}function _toPropertyKey(t){var e=_toPrimitive(t,"string");return"symbol"===_typeof(e)?e:String(e)}function _toPrimitive(t,e){if("object"!==_typeof(t)||null===t)return t;var o=t[Symbol.toPrimitive];if(void 0!==o){var n=o.call(t,e||"default");if("object"!==_typeof(n))return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===e?String:Number)(t)}var ItcCustomSelect=function(){function t(e,o){_classCallCheck(this,t),this._el="string"==typeof e?document.querySelector(e):e,this._params=o||{},this._onClickFn=this._onClick.bind(this),this._params.options&&(this._el.innerHTML=this.constructor.template(this._params),this._el.classList.add(this.constructor.EL)),this._elToggle=this._el.querySelector(this.constructor.DATA_TOGGLE),this._el.addEventListener("click",this._onClickFn)}return _createClass(t,[{key:"_onClick",value:function(t){var e=t.target,o=e.closest(this.constructor.DATA).dataset.select;"toggle"===o?this.toggle():"option"===o&&this._changeValue(e)}},{key:"_updateOption",value:function(t){var e=t.closest(".".concat(this.constructor.EL_OPTION)),o=this._el.querySelector(".".concat(this.constructor.EL_OPTION_SELECTED));return o&&o.classList.remove(this.constructor.EL_OPTION_SELECTED),e.classList.add(this.constructor.EL_OPTION_SELECTED),this._elToggle.textContent=e.textContent,this._elToggle.value=e.dataset.value,this._elToggle.dataset.index=e.dataset.index,this._el.dispatchEvent(new CustomEvent("itc.select.change")),this._params.onSelected&&this._params.onSelected(this,e),e.dataset.value}},{key:"_reset",value:function(){var t=this._el.querySelector(".".concat(this.constructor.EL_OPTION_SELECTED));return t&&t.classList.remove(this.constructor.EL_OPTION_SELECTED),this._elToggle.textContent="Выберите из списка",this._elToggle.value="",this._elToggle.dataset.index="-1",this._el.dispatchEvent(new CustomEvent("itc.select.change")),this._params.onSelected&&this._params.onSelected(this,null),""}},{key:"_changeValue",value:function(t){t.classList.contains(this.constructor.EL_OPTION_SELECTED)||(this._updateOption(t),this.hide())}},{key:"show",value:function(){var t=this;document.querySelectorAll(this.constructor.EL_SHOW).forEach((function(e){e.classList.remove(t.constructor.EL_SHOW)})),this._el.classList.add("".concat(this.constructor.EL_SHOW))}},{key:"hide",value:function(){this._el.classList.remove(this.constructor.EL_SHOW)}},{key:"toggle",value:function(){this._el.classList.contains(this.constructor.EL_SHOW)?this.hide():this.show()}},{key:"dispose",value:function(){this._el.removeEventListener("click",this._onClickFn)}},{key:"value",get:function(){return this._elToggle.value},set:function(t){var e=this,o=!1;this._el.querySelectorAll(".select__option").forEach((function(n){n.dataset.value===t&&(o=!0,e._updateOption(n))})),o||this._reset()}},{key:"selectedIndex",get:function(){return this._elToggle.dataset.index},set:function(t){var e=this._el.querySelector('.select__option[data-index="'.concat(t,'"]'));e&&this._updateOption(e),this._reset()}}],[{key:"template",value:function(t){var e=this,o=t.name,n=t.options,c=t.targetValue,i=[],s=-1,r="",l="Выберите из списка";return n.forEach((function(t,o){var n="";t[0]===c&&(n=" ".concat(e.EL_OPTION_SELECTED),s=o,r=t[0],l=t[1]),i.push('<li class="itc-select6__option'.concat(n,'" data-select="option"\n        data-value="').concat(t[0],'" data-index="').concat(o,'">').concat(t[1],"</li>"))})),'<button type="button" class="itc-select6__toggle" name="'.concat(o,'"\n      value="').concat(r,'" data-select="toggle" data-index="').concat(s,'">\n      ').concat(l,'</button><div class="itc-select6__dropdown">\n      <ul class="itc-select6__options">').concat(i.join(""),"</ul></div>")}},{key:"hideOpenSelect",value:function(){var t=this;document.addEventListener("click",(function(e){e.target.closest(".".concat(t.EL))||document.querySelectorAll(".".concat(t.EL_SHOW)).forEach((function(e){e.classList.remove(t.EL_SHOW)}))}))}},{key:"create",value:function(t,e){return this._el="string"==typeof t?document.querySelector(t):t,this._el?new this(t,e):null}}]),t}();_defineProperty(ItcCustomSelect,"EL","itc-select6"),_defineProperty(ItcCustomSelect,"EL_SHOW","itc-select6_show"),_defineProperty(ItcCustomSelect,"EL_OPTION","itc-select6__option"),_defineProperty(ItcCustomSelect,"EL_OPTION_SELECTED","itc-select6__option_selected"),_defineProperty(ItcCustomSelect,"DATA","[data-select]"),_defineProperty(ItcCustomSelect,"DATA_TOGGLE",'[data-select="toggle"]'),ItcCustomSelect.hideOpenSelect();var select6=new ItcCustomSelect("#select-6");
"use strict";var burger=document.querySelector(".header__menu-btn"),menu=document.querySelector(".navigation"),menuLinks=document.querySelectorAll(".navigation__link"),body=document.querySelector("body"),toggleClass=function(){menu.classList.toggle("navigation__active"),body.classList.toggle("lock")},deleteClass=function(){menu.classList.contains("navigation__active")&&(menu.classList.remove("navigation__active"),body.classList.remove("lock"))};burger.addEventListener("click",toggleClass),menuLinks.forEach((function(e){e.addEventListener("click",toggleClass)})),document.addEventListener("click",(function(e){var t=e.target;t.closest(".navigation")||t.closest(".header__menu-btn")||deleteClass()})),document.addEventListener("keyup",(function(e){"Escape"==e.key&&deleteClass()}));
"use strict";var sendForm=function(e){var t=e.formId,o=(e.someElem,document.getElementById(t)),n=document.querySelector(".form__title"),r=document.querySelector(".form__label-date"),l=document.querySelector(".form__label-people"),u=document.querySelector(".form__label-option"),c=document.querySelector(".form__label-name"),a=document.querySelector(".form__label-mail"),d=document.querySelector(".form__label-phone");r.style.border=null,l.style.border=null,u.style.border=null,c.style.border=null,a.style.border=null,d.style.border=null;var m=function(){var e,t,r=o.querySelectorAll("input"),l=new FormData(o),u={};n.textContent="Загрузка...",l.forEach((function(e,t){u[t]=e})),t=!0,r.forEach((function(e){e.style.border=null,"name"===e.name?e.value.length<2&&(c.style.border="1px solid red",t=!1):"mail"===e.name?0===e.value.length&&(a.style.border="1px solid red",t=!1):"phone"===e.name?(e.value.length<18||e.value.length>18)&&(d.style.border="1px solid red",t=!1):t=!0})),t?(e=u,fetch("https://jsonplaceholder.typicode.com/posts",{method:"POST",body:JSON.stringify(e),headers:{"Content-Type":"application/json"}}).then((function(e){return e.json()}))).then((function(e){n.textContent="Спасибо! Наш менеджер с вами свяжется!",r.forEach((function(e){e.value=""})),setInterval((function(){n.textContent="Бронирование тура"}),3e3)})).catch((function(e){n.textContent="Ошибка..."})):(n.textContent="Попробуйте ещё раз...",setTimeout((function(){n.textContent="Бронирование тура"}),2e3))};try{if(!o)throw new Error("Верните форму на место!");o.addEventListener("submit",(function(e){e.preventDefault(),m()}))}catch(e){}};sendForm({formId:"form"});
"use strict";var width=document.documentElement.clientWidth,aboutSlider=document.querySelector(".about__slider"),aboutSliderWrapper=document.querySelector(".about__slider-wrapper"),aboutSlide=document.querySelectorAll(".about__slide");width<=767&&(aboutSlider.classList.add("swiper1"),aboutSliderWrapper.classList.add("swiper-wrapper"),aboutSlide.forEach((function(e){e.classList.add("swiper-slide")}))),new Swiper(".swiper1",{spaceBetween:10,loop:!0,autoplay:{delay:3500,disableOnInteraction:!1},sliderPerView:1,keyboard:{enabled:!0},pagination:{el:".swiper-pagination"}}),new Swiper(".swiper",{slidesPerView:"auto",keyboard:{enabled:!0},navigation:{nextEl:".photo__slider-button_next",prevEl:".photo__slider-button_prev"}});
"use strict";
"use strict";var inputDate=document.querySelector(".form__input-date"),inputPeople=document.querySelector(".form__input-people"),inputOption=document.querySelector(".form__input-option"),inputName=document.querySelector(".form__input-name"),inputEmail=document.querySelector(".form__input-mail"),inputTel=document.querySelector(".form__input-phone"),footerInput=document.querySelector(".footer__form-input"),footerInputPlaceholder=document.querySelector(".footer__form-input[placeholder]"),labelDate=document.querySelector(".form__label-date"),labelPeople=document.querySelector(".form__label-people"),labelOption=document.querySelector(".form__label-option"),labelName=document.querySelector(".form__label-name"),labelMail=document.querySelector(".form__label-mail"),labelPhone=document.querySelector(".form__label-phone"),telMask=new Inputmask("+7 (999)-999-99-99");telMask.mask(inputTel),inputName.addEventListener("input",(function(e){e.target.value=e.target.value.replace(/[^а-яА-ЯёЁ\s]+/i,""),e.target.style.border=null,labelName.style.border=null})),inputName.addEventListener("invalid",(function(e){e.preventDefault(),e.target.style.border="1px solid red"})),inputEmail.addEventListener("input",(function(e){e.target.value=e.target.value.replace(/[^\w@\-.!~*']+/gi,""),e.target.style.border=null,labelMail.style.border=null})),inputEmail.addEventListener("invalid",(function(e){e.preventDefault(),e.target.style.border="1px solid red"})),inputTel.addEventListener("input",(function(e){e.target.value=e.target.value.replace(/[^\d+()-]+/gi,""),e.target.style.border=null,labelPhone.style.border=null})),inputTel.addEventListener("invalid",(function(e){e.preventDefault(),e.target.style.border="1px solid red"})),footerInput.addEventListener("input",(function(e){e.target.value=e.target.value.replace(/[^\w@\-.!~*']+/gi,""),e.target.style.borderBottom=null,e.target.style.color=null,footerInputPlaceholder.style.color=null,footerInput.style.borderBottom=null})),footerInput.addEventListener("invalid",(function(e){e.preventDefault(),e.target.style.color="red",e.target.style.borderBottom="1px solid red"}));