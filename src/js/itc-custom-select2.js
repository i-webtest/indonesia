class ItcCustomSelect {
  static EL = 'itc-select2';
  static EL_SHOW = 'itc-select2_show';
  static EL_OPTION = 'itc-select2__option';
  static EL_OPTION_SELECTED = 'itc-select2__option_selected';
  ...
  static template(params) {
    ...
    options.forEach((option, index) => {
      ...
      items.push(`<li class="itc-select2__option${selectedClass}" data-select="option"
