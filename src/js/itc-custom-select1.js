class ItcCustomSelect {
  static EL = 'itc-select1';
  static EL_SHOW = 'itc-select1_show';
  static EL_OPTION = 'itc-select1__option';
  static EL_OPTION_SELECTED = 'itc-select1__option_selected';
  ...
  static template(params) {
    ...
    options.forEach((option, index) => {
      ...
      items.push(`<li class="itc-select1__option${selectedClass}" data-select="option"
