!(function (e, t) {
  ...
  function z(t, n, r) {
    ...
    var d = [],
      h = Object.assign(q, { defaultVisitor: l, convertValue: f, isVisitable: U });
        ...
        if (!P.isUndefined(t)) {
          ...
          d.push(t),
            P.forEach(t, function (t, o) {
              !0 === (!P.isUndefined(t) && s.call(n, t, P.isString(o) ? o.trim() : o, r, h)) &&
                e(t, r ? r.concat(o) : [o]);
            }),
            d.pop();
        }
  ...
  var W,
    ...
    G =
      ('undefined' == typeof navigator ||
        ('ReactNative' !== (W = navigator.product) && 'NativeScript' !== W && 'NS' !== W)) &&
              ...
              (t = e) &&
                t.split('\n').forEach(function (e) {
                  (o = e.indexOf(':')),
                    ...
                    !n ||
                      (i[n] && oe[n]) ||
                      ('set-cookie' === n ? (i[n] ? i[n].push(r) : (i[n] = [r])) : (i[n] = i[n] ? i[n] + ', ' + r : r));
                }),
              i),
            )
          : e instanceof this
    ...
    be = {
      ...
      adapter:
        ('undefined' != typeof XMLHttpRequest
          ? (ye = me('xhr'))
          : 'undefined' != typeof process && 'process' === P.kindOf(process) && (ye = me('http')),
        ye),
      transformRequest: [
        function (e, t) {
          var n,
        ...
        r(e, [
          {
            ...
            value: function (e, t) {
              ...
              if (!i) {
                ...
                for (f.unshift.apply(f, o), f.push.apply(f, a), u = f.length, s = Promise.resolve(t); c < u; )
                  s = s.then(f[c++], f[c++]);
                return s;
              }
              u = o.length;
  ...
  P.forEach(['delete', 'get', 'head', 'options'], function (e) {
    Ce.prototype[e] = function (t, n) {
      return this.request(Re(n || {}, { method: e, url: t, data: (n || {}).data }));
    };
  }),
    P.forEach(['post', 'put', 'patch'], function (e) {
      function t(t) {
        return function (n, r, o) {
          return this.request(
            Re(o || {}, { method: e, headers: t ? { 'Content-Type': 'multipart/form-data' } : {}, url: n, data: r }),
          );
        };
      }
